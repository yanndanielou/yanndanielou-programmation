...
bool AntiMoustiqueMainForm::CreateMainList()
{
	...
	/* Create Popup */
	__pPopup = new Popup();
	__pPopup->Construct(true, Dimension(400,400));
	__pPopup->SetTitleText("Health warning!");
	__pPopup->SetShowState(true);

	/* Create Label */
	__pLabel = new Label();
	__pLabel->Construct(Rectangle(0, 0, 400, 250), L"This application can be harmful to health (particularly to people who suffer from a tinnitus) due to the high-frequence sounds generated");
	...
	__pButtonOk->Construct(Rectangle(150,250,100, 70), L"OK");

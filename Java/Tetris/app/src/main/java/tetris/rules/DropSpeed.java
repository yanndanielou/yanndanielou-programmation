...
public class DropSpeed {
	...
	private static final int NUMBER_OF_MILLISECOND_PER_FRAME = 1000 / NUMBER_OF_FRAMES_PER_SECOND;

	public DropSpeed(float gravity) {
	...
	public int getNumberOfMillisecondsBetweenEachStepDown() {
		...
		return millisecond;
		/*
		 * gravity = cell / 20ms 15 = cell / 20ms cell = 20ms * 15
		 */

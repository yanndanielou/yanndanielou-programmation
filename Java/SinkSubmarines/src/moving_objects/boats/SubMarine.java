...
/*
	...
	*/
	...
	private boolean check_if_must_fire_and_fire_if_needed() {
		...
		if (is_minimal_time_since_last_fire_fulfilled()) {
			...
			case FIRE_WHEN_ALLY_BOAT_IS_ABOVE:
				must_fire = right_of_submarine_is_at_least_right_of_left_of_ally_boat
						&& left_of_submarine_is_at_least_left_of_right_of_ally_boat;
				break;
			case FIRE_WHEN_ALLY_BOAT_IS_ABOVE_OR_NEARLY_ABOVE:
				must_fire = distance_between_left_ally_boat_and_right_of_submarine > -100
			...
			case FIRE_WHEN_ALLY_BOAT_IS_ABOVE_LAUNCH_POSITION:
				...
				must_fire = middle_of_submarine > ally_boat_left_end_x && middle_of_submarine < ally_boat_right_end_x;
				break;
			case FIRE_WITH_RANDOM_INTERVAL:
				Random rand = new Random();
				must_fire = rand.nextBoolean();
				break;
			default:
				break;
			}

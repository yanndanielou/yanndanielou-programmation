...
public class LoanPropertiesView extends ProjetImmobilierBaseView implements ActionListener {
  private static final long serialVersionUID = -5601747344003397604L;
  private static final LoanPropertiesView INSTANCE = new LoanPropertiesView();
  ...
  private LoanPropertiesView() {
    loanViewsMediator.setLoanPropertiesView(this);
  }

  public static LoanPropertiesView getInstance() {
    return INSTANCE;
  }

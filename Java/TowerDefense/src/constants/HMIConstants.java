...
public class HMIConstants {
	...
	public static final Color TOP_PANNEL_BACKGROUND_COLOR = Color.BLACK;

	
	public static final Color SCORE_IN_TOP_PANNEL_COLOR = Color.WHITE;
	public static final Color NEXT_ATTACKERS_WAVE_COUNTDOWN_IN_TOP_PANNEL_COLOR = Color.WHITE;
	public static final Color REMAINING_LIVES_IN_TOP_PANNEL_COLOR = Color.RED;
	public static final Color GOLD_IN_TOP_PANNEL_COLOR = Color.YELLOW;

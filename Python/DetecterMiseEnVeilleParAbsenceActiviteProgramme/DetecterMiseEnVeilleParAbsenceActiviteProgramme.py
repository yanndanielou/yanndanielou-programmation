...
def infinite_loop_detect_mise_en_veille_par_absence_activite():
    ...
    while True:    
        ...
        if duree_wait_realisee > 2*duree_attente_theorique_en_secondes:
            ...
            LoggerConfig.printAndLogInfo("Mise en veille du PC detectee, aux environs de :" + str(time.localtime(time_before_wait)) + " avec reprise aux environs de : " + str(time.localtime(time_before_wait)) + " . Duree de la veille estimee: " + str(timedelta(seconds=duree_wait_realisee)))
        #else:

...
class Graphe:
    ...
    def EstimerNombreDeSimulation(self):
        nbModelTrain = 2+8
    ...
    def RechercherAiguilleAvecSegments(self, _segment1, _segment2, _segment3):
    ...
    def ConstruireMissionsElementairesDeRegulationParMixage(self, pointsOptimisationsCBTC, gareTerminus):
    ...
    def ConstruireMissionsElementairesDeRegulationParImportation(self, pointsOptimisationsCBTC, fileToImport, _gareTerminus, _lignesSansArret):
        self.missionElementaireRegulation = {}
        #Les missions élémentaires de régulation sont construire en esseyant d'aller d'un quai d'une gare ou d'un PTA ou d'un PTES au quai d'une autre gare ou un autre PTA ou un autre PTES.
        combinaisonsOrigineDestination = {}

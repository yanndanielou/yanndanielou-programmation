...
java -jar ..\..\java\ExternalLibraries\pdfbox-app-3.0.1.jar fromtext -pageSize=A4 -standardFont=Times-Roman --input=watermark_text_to_add.txt --output=watermark_only.pdf

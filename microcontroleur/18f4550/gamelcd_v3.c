...
// microcontroleur gamel_trophy v3                                               //
//                          version 1.1 mars 06                                  //
//                                                                               //
...
//                                                                               //
//         lcd_gotoyx(char y, char x)  positionne le curseur                     //
//                                     (1,1) est le coin haut gauche             //
//                                     y correspond à la ligne, x à la colonne   //
//                                                                               //
//         lcd_puti(int nombre)        affiche un nombre entier                  //
//                                                                               //
//         lcd_putc(char lettre)       affiche un caractere y compris les speciaux/
//                                                                               //
//         lcd_puts(char* message)     affiche une chaine de caracteres  de la   //
//                                     memoire ram y compris les speciaux        //
//                                                                               //
//         lcd_putrs(char* message)     affiche une chaine de caracteres  de la  //
//                                     memoire programme y compris les speciaux  //
//                                                                               //
//                                                                               //
...
void lcd_init()
{
	...
	// Setup interface to LCD
        ...
        while(BusyXLCD());              // Wait if LCD busy
        lcd_gotoyx(1,1);                // Set Display data ram address to 0
...
/********************************************************************
*       Function Name:  lcd_gotoyx(char y, char x)                  *
*       Return Value:   void                                        *
*       Parameters:     char y pour la ligne et char x pour colonne *
*       Description:    Permet de placer le curseur ou on le veut   * 
*                       sur l'afficheur LCD                         *
********************************************************************/
void lcd_gotoyx(char y, char x)
{
   char address;
...
/********************************************************************
*       Function Name:  lcd_putrs issue de putsXLCD                 *
*       Return Value:   void                                        *
*       Parameters:     pointer to string in program memory (rom)   *
*       Description:    Ecrit une chaine de caractère à partir d'un *
                        pointeur vers char, à la suite du dernier   *
                        caractère écrit. Prend en compte \n \f \b   *
********************************************************************/
...
/********************************************************************
*       Function Name:  DelayxxTCY DelayPORXLCD DelayXLCD        *
*       Return Value:   void                                        *
*       Parameters:     void                                        *
...
void DelayPORXLCD() //provides at least 15ms delay (30ms environ)
{ Delay10KTCYx(36);
}
void DelayXLCD() //provides at least 5ms delay (10 ms environ)
{ Delay10KTCYx(12);
}
